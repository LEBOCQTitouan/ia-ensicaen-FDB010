 ...
 */
 public class MineralCell extends ExtractableCell {
    /**
     * Constructs a new {@code MineralCell} object at the specified position
     * with a given type, intensity, and quantity.
     * @param x the x coordinate of the cell
     * @param y the y coordinate of the cell
     * @param type the type of the cell
     * @param intensity the intensity of the minerals in the cell
     * @param quantity the quantity of minerals in the cell
     */
